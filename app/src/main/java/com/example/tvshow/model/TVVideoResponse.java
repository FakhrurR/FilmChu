...
public class TVVideoResponse {
    ...
    private List<ResultsTVVideo> results;
    ...
    public List<ResultsTVVideo> getResults() {
        return results;
    }

    public void setResults(List<ResultsTVVideo> results) {
        this.results = results;
    }

    public static class ResultsTVVideo {
        /**
